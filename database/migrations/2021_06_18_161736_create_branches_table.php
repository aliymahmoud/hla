...
class CreateBranchesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Branches", 'branches', 'name', 'fa-share-alt', [
            ["name", "Name", "Name", true, "", 0, 256, true],
            ["address", "Address", "Address", false, "", 0, 256, true],
            ["email", "Email", "Email", false, "", 0, 256, true],
            ["mobile", "Mobile", "Mobile", false, "", 0, 20, true],
            ["alternative_mobile", "Alternative Mobile", "Mobile", false, "", 0, 20, false],
            ["phone", "Phone", "Mobile", false, "", 0, 20, false],
            ["opened_at", "Opened At", "Date", false, "", 0, 0, true],
        ]);
