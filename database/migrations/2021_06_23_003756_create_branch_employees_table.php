...
class CreateBranchEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Branch_employees", 'branch_employees', 'branch_id', 'fa-slideshare', [
            ["branch_id", "Branch Name", "Dropdown", false, "", 0, 0, true, "@branches"],
            ["user_id", "Employee Name", "Dropdown", false, "", 0, 0, true, "@users"],
        ]);
