...
@section("headerElems")
@can("Branches-create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Branch</button>
@endcan
@endsection
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['route' => config('laraadmin.adminRoute').'.branches.store', 'id' => 'branch-add-form', 'files'=>true]) !!}
...
$(function () {
	...
	$("#branch-add-form .form-group").addClass("col-md-6");
});
</script>
@endpush
