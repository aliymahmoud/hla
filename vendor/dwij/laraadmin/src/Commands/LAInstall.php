		...
		try {
			...
			if ($this->confirm("This process may change/append to the following of your existing project files:"
				...
				*/
				...
				// if(!$this->fileContains($to."/webpack.mix.js", "admin-lte/AdminLTE.less")) {
				if(LAHelper::getLineWithString($to."/webpack.mix.js", "mix.less('admin-lte/AdminLTE.less', 'public/la-assets/css');") == -1) {
					$this->appendFile($from."/webpack.mix.js", $to."/webpack.mix.js");
				}
